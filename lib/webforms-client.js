...
function describeLoginFailure() {
  return 'A-kod-inloggning misslyckades: login-sidan returnerades efter inloggningsförsöket. Uppdatera lösenordet i GitHub Secrets (AKOD_PASSWORD) och kontrollera att lösenordet inte har gått ut.';
}
